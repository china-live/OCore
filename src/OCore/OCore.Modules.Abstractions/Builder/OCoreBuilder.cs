...
namespace Microsoft.Extensions.DependencyInjection
{
    public class OCoreBuilder
    {
        ...
        public OCoreBuilder RegisterStartup<T>() where T : class, IStartup
        {
        ...
        public OCoreBuilder ConfigureServices(Action<IServiceCollection, IServiceProvider> configure, int order = 0)
        {
        ...
        /// <param name="configure">The action to execute when configuring the services for a tenant.</param>
        /// <param name="order">The order of the action to execute. Lower values will be executed first.</param>
        public OCoreBuilder ConfigureServices(Action<IServiceCollection> configure, int order = 0)
        {
        ...
        /// <param name="order">The order of the action to execute. Lower values will be executed first.</param>
        public OCoreBuilder Configure(Action<IApplicationBuilder, IRouteBuilder, IServiceProvider> configure, int order = 0)
        {
            if (!_actions.TryGetValue(order, out var actions))
            {
                actions = _actions[order] = new StartupActions(order);
        ...
        /// <param name="configure">The action to execute when configuring the request's pipeling for a tenant.</param>
        /// <param name="order">The order of the action to execute. Lower values will be executed first.</param>
        public OCoreBuilder Configure(Action<IApplicationBuilder, IRouteBuilder> configure, int order = 0)
        {
        ...
        /// <param name="configure">The action to execute when configuring the request's pipeling for a tenant.</param>
        /// <param name="order">The order of the action to execute. Lower values will be executed first.</param>
        public OCoreBuilder Configure(Action<IApplicationBuilder> configure, int order = 0)
        {
