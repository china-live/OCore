...
namespace XCore.DeferredTasks
{
    ...
    public class DeferredTaskMiddleware
    {
        ...
        private readonly IShellHost _XCoreHost;
        private readonly ILogger _logger;

        public DeferredTaskMiddleware(RequestDelegate next, IShellHost XCoreHost, ILogger<DeferredTaskMiddleware> logger)
        {
            _next = next;
            _XCoreHost = XCoreHost;
            _logger = logger;
        }
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            if (shellSettings != null)
            {
                ...
                if (deferredTaskEngine != null && deferredTaskEngine.HasPendingTasks)
                {
                    ...
                    var shellContext = _XCoreHost.GetOrCreateShellContext(shellSettings);
