...
{
    public class RoleStore: RoleStoreBase<Role, string, UserRole, RoleClaim>
    {
        public RoleStore(AppDbContext context, IdentityErrorDescriber describer = null) : base(describer ?? new IdentityErrorDescriber()) 
        {
            if (context == null)
            {
